	...
	<table cellspacing="0" summary="" class="tab">
		...
		<c:forEach var="brand" items="${Brands}">
			<tr>
				<td>${brand.brandId}</td>
				<td>
					<img id='imgsImgSrc' src="${request_file_path}${brand.imgs}"   height="50" width="50"/>
				    <input type="hidden" id="img" value="${brand.imgs}">
                </td>
				...
				<td>
					<a href="${path }/item/editBrand.do?brandId=${brand.brandId}">编辑</a>
					<a id="delete" href="${path}/item/deleteBrand.do?brandId=${brand.brandId}&img=${brand.imgs}">删除</a>
