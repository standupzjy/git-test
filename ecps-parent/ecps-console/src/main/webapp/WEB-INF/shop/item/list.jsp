...
<script type="text/javascript" src="${path}/ecps/console/res/js/jquery.jqprint-0.3.js"/>
...
<div class="frameR"><div class="content">
	...
	<form action="${path}/item/showItem.do" method="post" id="showForm">
		...
		<input type="hidden" id="showStatus3" name="showStatus">
