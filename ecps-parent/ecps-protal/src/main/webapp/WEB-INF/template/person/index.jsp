...
<div class="w loc">
	...
	<p class="l"><a href="#" title="商城首页">商城首页</a>
		<samp>|</samp>
		<a href="${path}/user/login/toPersonIndex.do" title="我的商城">我的商城</a>
	</p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="${path}/user/login/toAddress.do" title="收货地址">收货地址</a></li>
	...
	<div class="r wr profile">
		...
		<div class="box_orange">
			<dl class="dl_pro">
				<dt><b class="red">${username}</b>，欢迎您！<a href="${base}/editPtlUser.do" title="编辑个人资料" class="blue">编辑个人资料</a></dt>
				<dd>
					<p>总消费额：<b>￥<fmt:formatNumber value="${myTotalCash/100}" pattern="#0.00" /></b></p>
					<p>完成订单数：<b>${mySuccessOrder}</b></p>
					<p>我的订单：<b><a href="${base}/center/orderList.do" title="我的订单：${myOrderNum}">${myOrderNum}</a></b></p>
					<p>我的收藏：<b><a href="${base}/center/favors.do" title="我的收藏：${myFavorNum}">${myFavorNum}</a></b></p>
				</dd>
			</dl>
		</div>

		<h2 class="h2 h2_filter mt"><em>我的订单</em><cite><a href="${base}/center/orderList.do" title="查看全部订单" class="blue">查看全部订单<samp>&gt;&gt;</samp></a></cite></h2>
		...
		<h2 class="h2 h2_filter mt"><em>我的收藏</em><cite><a href="${base}/center/favors.do" title="查看全部订单" class="blue">查看全部收藏<samp>&gt;&gt;</samp></a></cite></h2>
