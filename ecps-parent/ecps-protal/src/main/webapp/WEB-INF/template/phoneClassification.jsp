	...
	<div class="bg_gray mt ofc">
			...
			<ul class="uls i_150x150 x4_150x150b">
				<c:forEach items="${list}" var="item">
					<li>
						<a href="${path}/html/${item.itemId}.html" title="张同来" target="_blank" class="pic"><img src="${request_file_path}${item.imgs}"/></a>
						<dl>
							<!-- dt 10个文字+... -->
