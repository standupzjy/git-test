...
<script type="text/javascript" src="${path}/res/js/template/passport/login.js"></script>
...
<div class="sign">
	...
	<div class="r">
		...
		<form id="jvForm" action="${path}/user/login.do" method="post">
			<input id="tip" type="hidden" value="${tip}">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img id="captchaChangImg" src="${path}/user/getImg.do" onclick="changImg()" class="code" alt="换一张" />
				<a href="javascript:void(0);" onclick="changImg()" title="换一张">换一张</a>
			</li>
