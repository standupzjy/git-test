	...
	<div class="r wr">
			...
			<form method="post" action="" name="" class="infor">
				...
				<div class="box_orange">
					...
					<li><label>规　　格：</label><div class="pre spec">
						<c:forEach items="${item.skuList}" var="sku" varStatus="status">
							<c:choose>
					...
					<li><label>我 要 买：</label>
						...
						<input readonly type="text" name="" value="1" class="num" size="3" />
		...
		<div class="box bg_white ofc">
			...
			<div id="detailTab2" style="display:none">
				...
				<c:forEach items="${item.paraValueList}" var="paraValue">
					<tr>
