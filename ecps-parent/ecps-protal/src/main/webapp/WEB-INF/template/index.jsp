...
<script type="text/javascript" src="${path}/res/js/template/index.js"></script>
...
<div class="bar"><div class="bar_w">
	<p class="l">
		...
		<span class="l">
			欢迎来到中国移动！<a href="javascript:void(0);" title="登录" id="loginAlertIs" class="orange">
								<samp>[</samp>请登录<samp>]</samp>
		  				    </a>&nbsp;<a href="passport/register.html" title="免费注册">免费注册</a>
		...
		<h2 class="h2 h2_filter mt"><em title="手机商品筛选">手机&nbsp;-&nbsp;商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			...
			<ul class="uls filter">
				...
				<li><b>价格：</b><p>
					...
					<a href="javascript:void(0);" fValue="5000-9999999999999999" fType="price">5000以上</a>
				</p></li>
				...
				<li><b>商品搜索：</b><p>
                    ...
                    <input type="submit" value="搜索" onclick="find()" class="hand btn60x26" />
				</p></li>
				...
				<li class="line"></li>
				<li class="alg_c after">
					<a href="javascript:void(0);" title="高级搜索" class="btn80x22 open">高级搜索</a>
				</li>
			</ul>
